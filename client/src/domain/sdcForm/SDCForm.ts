...
type DEType = 'date' | 'string' | 'decimal' | 'integer';

export type SDCResponseQuestionBody = DEType;

const SDCFormRecord = immutableRecord<SDCFormModel>({
  metadata: {},
  SDCFormId: '',
  title: '',
  version: '',
...
export class SDCForm extends SDCFormRecord {}
